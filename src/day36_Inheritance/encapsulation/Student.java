...
public class Student {
    ...
    public void setAge(int age) {
        ...
        if(age > 90 || age < 5){
            System.out.println("Age should not be set less than 5 or greater than 90");
            return;
        }
    ...
    public void setGender(char gender) {
        ...
        if( !(gender == 'F' || gender == 'M') ){
            System.out.println("Gender should not be set to any character other than: 'M' and 'F'");
            return;
        }
    ...
    public void setGrade(char grade) {
        ...
        if( !(grade == 'A' || grade == 'B' || grade =='C' || grade == 'D' || grade == 'F') ){
            System.out.println("Grade should not be set to any characters other than: 'A', 'B', 'C', 'D', and 'F'");
            return;
        }
