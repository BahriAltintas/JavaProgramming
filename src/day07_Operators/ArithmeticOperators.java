...
public class ArithmeticOperators {
    public static void main(String[] args) {
        ...
        System.out.println(num1 +" devided by " +num2+ " is equal to "+ division+ " with a remainder of "+remainder);

        // what is the remainder of 25 devided 4:

        System.out.println( 25%4);

        // what is the remainder of 25 devided 5:
