...
public class MapPractice2 {
    ...
    public static void main(String[] args) {
        ...
        for (Map.Entry<String, Integer> eachPair : map.entrySet()) {
            String eachPairKey = eachPair.getKey();
            int eachPairValue = eachPair.getValue();

            if (eachPairValue > maxSalary){
                maxSalary = eachPairValue;
                name1 = eachPairKey;
            }

            if(eachPairValue < minSalary){
                minSalary = eachPairValue;
                name2 = eachPairKey;
            }
